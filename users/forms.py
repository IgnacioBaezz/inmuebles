...
class UserProfileForm(ModelForm):
    class Meta():
        ...
        widgets = {
            "email":EmailInput(attrs={"class":"form-control","type":"email","placeholder":"Correo electronico"}),
            "first_name":TextInput(attrs={"class":"form-control","placeholder":"Nombre"}),
            "last_name":TextInput(attrs={"class":"form-control","placeholder":"Apellido","type":"text"}),
